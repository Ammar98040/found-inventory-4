...
urlpatterns = [
    ...
    path('api/invoice/product/', views.api_invoice_product, name='api_invoice_product'),
    path('api/invoice/save/', views.api_save_invoice, name='api_save_invoice'),

    # تقارير المبيعات الموحدة
    path('sales-report/', views.sales_report, name='sales_report'),
    path('api/sales-report/', views.api_sales_report, name='api_sales_report'),
    path('api/orders-total/', views.api_orders_total, name='api_orders_total'),
